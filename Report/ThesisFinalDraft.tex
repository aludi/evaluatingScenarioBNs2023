...
\item We create the baseline by running the simulation for 10,000 iterations. In Table~\ref{heretic} we present the frequencies of the three outcomes, as well as their preference ordering.
...
\begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.6\linewidth]{../../FINALACCURACY.pdf}
