...
var GridVisualization = function(width, height, gridWidth, gridHeight, context, interactionHandler) {
        ...
        this.drawLayer = function(portrayalLayer) {
                ...
                for (var i in portrayalLayer) {
                        ...
                        if (p.Shape == "rect")
                                ...
                                this.drawCircle(p.x, p.y, p.r, p.Color, p.stroke_color, p.Filled, p.text, p.text_color, p.opacity);
                        else if (p.Shape == "arrowHead")
                                this.drawArrowHead(p.x, p.y, p.heading_x, p.heading_y, p.scale, p.Color, p.stroke_color, p.Filled, p.text, p.text_color, p.opacity);
                        else
                                this.drawCustomImage(p.Shape, p.x, p.y, p.scale, p.text, p.text_color, p.opacity)
                }
        ...
        */
        this.drawCircle = function(x, y, radius, colors, stroke_color, fill, text, text_color, opacity) {
        ...
        */
        ...
        this.drawCustomImage = function (shape, x, y, scale, text, text_color_, opacity) {
                var img = new Image();
