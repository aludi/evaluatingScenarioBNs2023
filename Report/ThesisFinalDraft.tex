...
\makebox[\textwidth][c]{
\includegraphics[width=0.7\textwidth]{GroteMarktPrivateEND/plots/freq/evidence_progress_GroteMarktPrivate50_50_0.2700.pdf}
\includegraphics[width=0.7\textwidth]{GroteMarktPrivateEND/plots/freq/evidence_progress_GroteMarktPrivate1000_1000_0.2700.pdf}}
\caption{Most relevant }
\label{te}
\end{subfigure}
\begin{subfigure}{\textwidth}
\makebox[\textwidth][c]{
\includegraphics[width=0.7\textwidth]{GroteMarktPrivateEND/plots/freq/evidence_progress_GroteMarktPrivate50_50_52.6300.pdf}
...
In order to do this, we created a network manually. This was done by ordering the network 
 ...
 \begin{figure}[htbp]
\begin{center}
\includegraphics[width=0.7\linewidth]{../notebooks/manualNetwork.pdf}
