...
\begin{subfigure}{.5\textwidth}
\centering
\includegraphics[width=0.9\linewidth]{../experiments/VlekNetwork/plots/performance_KBFull.pdf}
...
We see in the previous item that the loss of precision only begins to affect the accuracy of the network at a precision of about 0.3, which means that all the values in the cpts in the Bayesian Network are restricted to 0, 0.33, 0.66 and 0.99. 
